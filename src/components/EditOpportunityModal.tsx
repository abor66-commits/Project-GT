  ...
  useEffect(() => {
    if (opportunity) {
      setFormData({
        ...
        closeDate: opportunity.closeDate ? new Date(opportunity.closeDate).toISOString().split('T')[0] : new Date().toISOString().split('T')[0],
    ...
    startTransition(async () => {
      try {
        ...
        if (res.ok) {
          ...
          alert(t('opportunities.form.save_error'));
        }
      } catch {
        alert(t('opportunities.form.save_error'));
      }
  ...
  return (
    <div className="modal-overlay" style={{ zIndex: 2000 }} onClick={onClose}>
      ...
      >
        ...
        {/* Form body */}
        <form onSubmit={handleSubmit} style={{ padding: '24px 28px', display: 'flex', flexDirection: 'column', gap: '18px', maxHeight: '70vh', overflowY: 'auto' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{
                ...
                background: '#dbeafe', padding: '3px 8px', borderRadius: '6px',
              }}>
          ...
          <div style={{
            ...
            >
              {isPending ? t('opportunities.form.saving') : t('opportunities.form.save')}
            </button>
          </div>
        </form>
      </div>
